...
class StatusPalette {
  ...
  static const _light = <StatusTone, StatusPalette>{
    ...
    StatusTone.holidayRegular: StatusPalette(
      Color(0xFFFEE2E2),
      Color(0xFF991B1B),
    ),
    StatusTone.holidaySpecial: StatusPalette(
      Color(0xFFFEF3C7),
      Color(0xFF92400E),
    ),
    StatusTone.holidayWorking: StatusPalette(
      Color(0xFFE8E9FF),
      Color(0xFF635BFF),
    ),
    StatusTone.attendanceOnLeave: StatusPalette(
      Color(0xFFE6F0FB),
      Color(0xFF1F5AA8),
    ),
  };
