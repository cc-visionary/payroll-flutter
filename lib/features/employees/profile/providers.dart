...
final hiringEntityNameProvider = FutureProvider.family<String?, String>((
  ref,
  id,
) async {
  final row = await Supabase.instance.client
...
final managerNameProvider = FutureProvider.family<String?, String>((
  ref,
  id,
) async {
  final row = await Supabase.instance.client
...
final financialsByEmployeeProvider =
    FutureProvider.family<List<Map<String, dynamic>>, FinancialsQuery>((
      ...
      for (final lr
          in (lineRows as List<dynamic>).cast<Map<String, dynamic>>()) {
...
final employmentEventsProvider =
...
final employeeDocumentsProvider = FutureProvider.autoDispose
    .family<List<Map<String, dynamic>>, String>((ref, employeeId) async {
      final rows = await Supabase.instance.client
...
final timelineProvider = FutureProvider.family<List<TimelineEntry>, String>((
  ...
  final payslipRows = await client
      .from('payslips')
      .select(
        'id, net_pay, approval_status, created_at, '
