...
List<ValidationError> validateCoe(CoeInputs i) {
  ...
  if (i.dateStart == null) {
    errs.add(const ValidationError('dateStart', 'Hire date is required.'));
  }
  if (i.dateEnd == null) {
    errs.add(const ValidationError('dateEnd', 'Separation date is required.'));
  }
  if (i.dateStart != null &&
      i.dateEnd != null &&
    ...
    errs.add(
      const ValidationError(
        'dateEnd',
        'Separation date must be on or after hire date.',
      ),
    );
  }
