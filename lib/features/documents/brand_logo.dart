...
Future<Uint8List?> loadBrandLogoBytes({
  String? companyName,
  String? code,
}) async {
  ...
  final isGameCove =
      n.contains('gamecove') || n.contains('game cove') || c.contains('gc');
  final asset = isGameCove
      ? 'assets/GameCove Logo.png'
      : 'assets/Luxium Logo.png';
  try {
