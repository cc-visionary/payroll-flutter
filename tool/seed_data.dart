...
List<Map<String, Object?>> loadRoleScorecards() =>
    _loadFixture('role_scorecards');
List<Map<String, Object?>> loadEmployees() => _loadFixture('employees');
List<Map<String, Object?>> loadEmployeeStatutoryIds() =>
    _loadFixture('employee_statutory_ids');
...
const _allPermissions = <String>[
  ...
  'or_incentive:view',
  'or_incentive:submit',
  'or_incentive:approve',
  'department:view',
  'department:manage',
  'leave_type:view',
  'leave_type:manage',
  'role_scorecard:view',
  'role_scorecard:manage',
  'hiring:view',
  'hiring:create',
  'hiring:edit',
  'hiring:convert',
