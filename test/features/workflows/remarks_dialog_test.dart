    ...
    home: Scaffold(
      body: Builder(
        builder: (context) => ElevatedButton(
          onPressed: () async {
            onResult(await showRemarksDialog(
              context,
...
void main() {
  testWidgets('required reason: Confirm is disabled until text is entered',
    ...
    String? result;
    var returned = false;
    await _open(tester, requireNonEmpty: true, onResult: (r) {
      result = r;
      returned = true;
    });
  ...
  testWidgets('optional reason: Confirm is enabled while empty', (tester) async {
    String? result;
