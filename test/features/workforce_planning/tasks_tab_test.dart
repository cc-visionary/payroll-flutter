...
void main() {
  ...
  testWidgets('a card-linked task renders under its card + area heading', (
    tester,
  ) async {
    await tester.pumpWidget(
      ProviderScope(
          ...
          wpTasksProvider.overrideWith(
            (ref) async => const [
              WpTask(
                ...
                roleScorecardId: 'rc1',
                responsibilityArea: 'Warehousing',
              ),
            ],
          ),
  ...
  testWidgets(
    'an uncosted task (no times, no minutes) shows the "not costed" chip',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    ...
    'employee not in the active-employees list',
    (tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            wpTaskAssignmentsProvider.overrideWith(
              (ref) async => const <WpTaskAssignment>[],
            ),
          ],
          child: MaterialApp(
            home: Scaffold(
