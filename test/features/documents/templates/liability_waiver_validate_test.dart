...
void main() {
  ...
  test('missing company name flagged', () {
    ...
    expect(
      validateLiabilityWaiver(i).any((e) => e.field == 'companyName'),
      true,
    );
  });
  ...
  test('null outing date flagged', () {
    ...
    expect(
      validateLiabilityWaiver(i).any((e) => e.field == 'outingDate'),
      true,
    );
  });
  ...
  test('missing outing location flagged', () {
    ...
    expect(
      validateLiabilityWaiver(i).any((e) => e.field == 'outingLocation'),
      true,
    );
  });
  ...
  test('missing signing place flagged', () {
    ...
    expect(
      validateLiabilityWaiver(i).any((e) => e.field == 'signingPlace'),
      true,
    );
  });
}
