...
void main() {
  ...
  test('empty position flagged', () {
    expect(
      validateEmploymentContract(
        valid().copyWith(position: ''),
      ).any((e) => e.field == 'position'),
      true,
    );
  });
  ...
  test('empty monthlySalary flagged', () {
    expect(
      validateEmploymentContract(
        valid().copyWith(monthlySalary: ''),
      ).any((e) => e.field == 'monthlySalary'),
      true,
    );
  });
  ...
  test('empty representativeName flagged', () {
    expect(
      validateEmploymentContract(
        valid().copyWith(representativeName: ''),
      ).any((e) => e.field == 'representativeName'),
      true,
    );
  });
  ...
  test('null probationStart flagged', () {
    expect(
      validateEmploymentContract(
        valid().copyWith(probationStart: null),
      ).any((e) => e.field == 'probationStart'),
      true,
    );
  });
  ...
  test('probationEnd before start flagged', () {
    ...
    expect(
      validateEmploymentContract(i).any((e) => e.field == 'probationEnd'),
      true,
    );
  });
  ...
  test('empty responsibilities flagged', () {
    expect(
      validateEmploymentContract(
        valid().copyWith(responsibilities: const []),
      ).any((e) => e.field == 'responsibilities'),
      true,
    );
  });
  ...
  test('responsibility with empty area flagged', () {
    ...
    expect(
      validateEmploymentContract(
        i,
      ).any((e) => e.field == 'responsibilities[0].area'),
      true,
    );
  });
  ...
  test('responsibility with no tasks flagged', () {
    ...
    expect(
      validateEmploymentContract(
        i,
      ).any((e) => e.field == 'responsibilities[0].tasks'),
      true,
    );
  });
  ...
  test('zero workHoursPerDay flagged', () {
    expect(
      validateEmploymentContract(
        valid().copyWith(workHoursPerDay: 0),
      ).any((e) => e.field == 'workHoursPerDay'),
      true,
    );
  });
  ...
  test('zero nonCompeteMonths flagged', () {
    expect(
      validateEmploymentContract(
        valid().copyWith(nonCompeteMonths: 0),
      ).any((e) => e.field == 'nonCompeteMonths'),
      true,
    );
  });
}
