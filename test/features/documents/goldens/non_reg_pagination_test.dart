...
void main() {
  test(
    'Non-Reg with 5 findings × 3 sub-findings produces multi-page PDF',
    () async {
      ...
      final inputs = NonRegInputs(
        ...
        findings: [
          for (var i = 0; i < 5; i++)
            FindingSection(
              title:
                  'Finding section ${i + 1} — long descriptive title for '
                  'pagination testing',
              standard:
              ...
              subFindings: [
                for (var s = 0; s < 3; s++)
                  SubFinding(
                    ...
                    body:
                        'Detailed body text for sub-finding ${s + 1}. '
