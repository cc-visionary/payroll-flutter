...
void main() {
  test(
    'DAILY: full paid leave day emits a PAID_LEAVE earning at daily rate',
    () {
  ...
  test(
    'DAILY: ON_LEAVE day with worked minutes (mixed) emits no PAID_LEAVE line',
    () {
      final p = _profile(WageType.DAILY, _d('1000'));
      final ps = _run(p, [
        _day(
