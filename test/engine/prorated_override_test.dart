...
void main() {
  final raise = [
    _change(id: 'C1', effective: '2026-07-17', newSalary: '38000'),
  ];
  ...
  test(
    'day BEFORE the effective date overrides down to the old scorecard rate',
    () {
  ...
  test(
    'the effective date itself uses the new rate -> null (matches standard)',
    () {
  ...
  test(
    'null newBaseSalary carries forward prevBaseSalary, not the scorecard rate',
    () {
      final comp = [
  ...
  test(
    "DAILY wage-type change passes through the change's own wage type, not the scorecard's",
    () {
      final comp = [
        _change(
          id: 'C1',
  ...
  test(
    'null newWageType carries forward prevWageType, not the scorecard wage type',
    () {
      final comp = [
  ...
  test(
    'role change: pre-change day uses prevBaseSalary, not the repointed scorecard',
    () {
  ...
  test(
    'pre-change day with multiple changes uses the EARLIEST change prevBaseSalary',
    () {
